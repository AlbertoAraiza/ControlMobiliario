...
class FileUtils @Inject constructor() {
    fun getPath(uri: Uri, ctx: Context): String? {
        ...
        if (isDownloadsDocument(uri)) {
            ...
            if (id.startsWith("msf") || !id.contains(":")) {
        ...
        if (isWhatsAppFile(uri)) {
            return getFilePathForWhatsApp(uri, ctx)
        }
        if ("content".equals(uri.scheme, ignoreCase = true)) {
            ...
            return copyFileToInternalStorage(uri, "userfiles", ctx)
        }
    ...
    private fun getPathFromExtSD(pathData: Array<String>): String {
        ...
        if ("primary".equals(type, ignoreCase = true)) {
            fullPath = getExternalStorageDirectory().toString() + relativePath
        ...
        fullPath = System.getenv("EXTERNAL_SDCARD_STORAGE")!! + relativePath
